...
function App() {
  ...
  const filteredEvents = events.filter((event) =>
    event.process_name?.toLowerCase().includes(search.toLowerCase()),
  );

  const alertCount = events.filter((event) => event.alert).length;
  ...
  return (
    <div className="app">
      ...
      <div className="sidebar">
        <div className="logo">Mini EDR</div>

        <div className="sidebar-menu">
          <div className="sidebar-item">Dashboard</div>

          <div className="sidebar-item">Telemetry</div>

          <div className="sidebar-item">Alerts</div>

          <div className="sidebar-item">Hosts</div>
        </div>
      </div>
      ...
      <div className="main">
        ...
        <div className="alerts-section">
          <div className="alerts-title">Recent Critical Alerts</div>
              ...
              .map((alert, index) => (
                <div className="alert-card" key={index}>
                  <div className="alert-header">
                    <div className="alert-name">{alert.alert}</div>
                  ...
                  <div className="mitre-tag">MITRE: {alert.mitre}</div>
                </div>
              ))}
          </div>
        </div>
        ...
        <div className="table-container">
          <div className="table-header">Live Telemetry</div>
                ...
                {filteredEvents
                  ...
                  .map((event, index) => (
                    <tr key={index}>
                      ...
                      <td className="command">{event.cmdline}</td>

                      <td>
                        {event.alert ? (
                          <span className="alert">{event.alert}</span>
                        ) : (
